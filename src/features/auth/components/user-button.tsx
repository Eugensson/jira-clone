    ...
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger className="outline-none relative">
        <Avatar className="size-10 hover:opacity-75 transition-opacity border border-neutral-300">
          <AvatarFallback className="bg-neutral-200 text-neutral-500 font-medium flex justify-center items-center">
            {avatarFallback}
          </AvatarFallback>
        </Avatar>
      </DropdownMenuTrigger>
      ...
      >
        <div className="flex flex-col justify-center items-center gap-2 px-2.5 py-4">
          <Avatar className="size-[52px] border border-neutral-300">
            <AvatarFallback className="bg-neutral-200 text-xl text-neutral-500 font-medium flex justify-center items-center">
              {avatarFallback}
            </AvatarFallback>
          </Avatar>
